...
class MoveDownRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveDownRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveDownRequest
    let len;
    let data = new MoveDownRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveDownRequest(null);
    if (msg.cm !== undefined) {
      resolved.cm = msg.cm;
    }
    else {
...
class MoveDownResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveDownResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveDownResponse
    let len;
    let data = new MoveDownResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveDownResponse(null);
...
module.exports = {
  Request: MoveDownRequest,
  Response: MoveDownResponse,
  md5sum() { return '93e098705f3e00df20d27935dc5efafa'; },
  datatype() { return 'tello_driver/MoveDown'; }
};
